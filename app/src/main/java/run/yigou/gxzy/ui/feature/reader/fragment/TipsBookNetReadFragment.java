...
import run.yigou.gxzy.ui.bookshelf.BookCollectCaseFragment;
...
//    }
    ...
    private void performGlobalSearch(String keyword) {
        ...
        android.util.Pair<List<run.yigou.gxzy.ui.feature.reader.entity.GroupData>, 
                          List<List<run.yigou.gxzy.ui.feature.reader.entity.ItemData>>> result = 
        ...
        List<run.yigou.gxzy.ui.feature.reader.entity.GroupData> groupDataList = result.first;
        List<List<run.yigou.gxzy.ui.feature.reader.entity.ItemData>> itemDataList = result.second;
        ...
        if (adapter != null) {
            ...
            if (itemDataList != null) {
                for (List<run.yigou.gxzy.ui.feature.reader.entity.ItemData> items : itemDataList) {
                    if (items != null) {
