...
package run.yigou.gxzy.ui.feature.reader.adapter.refactor.event;
...
/**
 * 阅读模式点击处理器
 * 处理阅读界面的Header和Child点击事件
 */
public class ReadModeClickHandler implements ClickEventHandler {
     ...
     */
    public ReadModeClickHandler(@NonNull Context context,
    ...
    /**
     * Child文本点击事件 - 切换显示模式(text/note/video)
     *
     * @param groupPosition 组位置
     * @param childPosition 子项位置
     * @param entity        数据实体
