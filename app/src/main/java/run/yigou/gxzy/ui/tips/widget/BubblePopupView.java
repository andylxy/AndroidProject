/*
 * 项目名: AndroidProject
 * 类名: BubblePopupView.java
 * 包名: run.yigou.gxzy.ui.tips.widget.BubblePopupView
 * 作者 : Zhs (xiaoyang_02@qq.com)
 * 当前修改时间 : 2024年09月10日 14:00:01
 * 上次修改时间: 2024年09月10日 14:00:01
...
//        LogUtil.e("rawX:" + rawX + ",rawY:" + rawY + ",location[0]:" + location[0] + ",location[1]" + location[1]);
        if (mIsShowTouchLocation) {
            ...
            Log.e("showPopupListWindow: ", "navigationBarHeight:" + mReversalHeight + rawY + ",rawY:" + rawY);
