...
package run.yigou.gxzy.ui.feature.reader.adapter.refactor;
...
import run.yigou.gxzy.ui.feature.reader.adapter.refactor.event.ReadModeClickHandler;
import run.yigou.gxzy.ui.feature.reader.adapter.refactor.event.ReadModeLongClickHandler;
import run.yigou.gxzy.ui.feature.reader.adapter.refactor.model.DataAdapter;
import run.yigou.gxzy.ui.feature.reader.adapter.refactor.model.GroupData;
...
import run.yigou.gxzy.ui.feature.reader.adapter.refactor.viewholder.TipsHeaderViewHolder;
import run.yigou.gxzy.ui.feature.reader.adapter.refactor.viewholder.ViewHolderFactory;
...
public class RefactoredExpandableAdapter extends BaseRefactoredAdapter 
    ...
    public void setSearchData(
        ...
        List<run.yigou.gxzy.ui.feature.reader.adapter.refactor.model.GroupData> modelGroupList = new ArrayList<>();
        ...
        for (int i = 0; i < groupDataList.size() && i < itemDataList.size(); i++) {
            ...
            List<run.yigou.gxzy.ui.feature.reader.adapter.refactor.model.ItemData> modelItems = new ArrayList<>();
            if (sourceItems != null) {
                for (run.yigou.gxzy.ui.feature.reader.entity.ItemData sourceItem : sourceItems) {
                    ...
                    // 创建 model.ItemData
                    run.yigou.gxzy.ui.feature.reader.adapter.refactor.model.ItemData modelItem = 
                        new run.yigou.gxzy.ui.feature.reader.adapter.refactor.model.ItemData(
            ...
            // 创建 model.GroupData
            run.yigou.gxzy.ui.feature.reader.adapter.refactor.model.GroupData modelGroup = 
                new run.yigou.gxzy.ui.feature.reader.adapter.refactor.model.GroupData(
