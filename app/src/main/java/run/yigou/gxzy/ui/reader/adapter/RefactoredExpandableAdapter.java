 ...
 * 包名: run.yigou.gxzy.ui.reader.adapter.refactor
 * 作者: Refactor Team
 * 创建时间: 2025年12月10日
...
public class RefactoredExpandableAdapter extends BaseRefactoredAdapter 
    ...
    public void setSearchData(
            @NonNull List<run.yigou.gxzy.ui.reader.entity.GroupData> groupDataList,
            @NonNull List<List<run.yigou.gxzy.ui.reader.entity.ItemData>> itemDataList) {
