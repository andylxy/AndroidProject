...
/** 
 * DAO for table "ALIA_ZHONG_YAO".
*/
public class AliaZhongYaoDao extends AbstractDao<AliaZhongYao, Long> {

    public static final String TABLENAME = "ALIA_ZHONG_YAO";

    /**
     * Properties of entity AliaZhongYao.<br/>
    ...
    public AliaZhongYaoDao(DaoConfig config) {
        super(config);
    }
    
    public AliaZhongYaoDao(DaoConfig config, DaoSession daoSession) {
    ...
    public static void createTable(Database db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"ALIA_ZHONG_YAO\" (" + //
    ...
    public static void dropTable(Database db, boolean ifExists) {
        String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "\"ALIA_ZHONG_YAO\"";
        db.execSQL(sql);
    }

    @Override
    protected final void bindValues(DatabaseStatement stmt, AliaZhongYao entity) {
        stmt.clearBindings();
    ...
    @Override
    protected final void bindValues(SQLiteStatement stmt, AliaZhongYao entity) {
        stmt.clearBindings();
    ...
    @Override
    public AliaZhongYao readEntity(Cursor cursor, int offset) {
        AliaZhongYao entity = new AliaZhongYao( //
    ...
    @Override
    public void readEntity(Cursor cursor, AliaZhongYao entity, int offset) {
    ...
    @Override
    protected final Long updateKeyAfterInsert(AliaZhongYao entity, long rowId) {
        entity.setYaoAliaId(rowId);
        return rowId;
    }
    
    @Override
    public Long getKey(AliaZhongYao entity) {
        if(entity != null) {
    ...
    @Override
    public boolean hasKey(AliaZhongYao entity) {
