...
/** 
 * DAO for table "ZHONG_YAO_ALIA".
*/
public class ZhongYaoAliaDao extends AbstractDao<ZhongYaoAlia, Long> {

    public static final String TABLENAME = "ZHONG_YAO_ALIA";

    /**
     * Properties of entity ZhongYaoAlia.<br/>
    ...
    public ZhongYaoAliaDao(DaoConfig config) {
        super(config);
    }
    
    public ZhongYaoAliaDao(DaoConfig config, DaoSession daoSession) {
    ...
    public static void createTable(Database db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"ZHONG_YAO_ALIA\" (" + //
    ...
    public static void dropTable(Database db, boolean ifExists) {
        String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "\"ZHONG_YAO_ALIA\"";
        db.execSQL(sql);
    }
