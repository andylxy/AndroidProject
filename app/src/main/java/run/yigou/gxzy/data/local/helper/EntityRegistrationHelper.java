...
public class EntityRegistrationHelper {
    ...
    static {
        ...
        v1Entities.add(run.yigou.gxzy.data.local.gen.BookDao.class);
        v1Entities.add(run.yigou.gxzy.data.local.gen.ChatMessageBeanDao.class);
        v1Entities.add(run.yigou.gxzy.data.local.gen.ChatSessionBeanDao.class);
        v1Entities.add(run.yigou.gxzy.data.local.gen.SearchHistoryDao.class);
        v1Entities.add(run.yigou.gxzy.data.local.gen.UserInfoDao.class);
